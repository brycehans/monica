...
const common = {
  ...
  loadedLanguages: ['en'] as string[], // our default language that is preloaded
  ...
  _setI18nLanguage(lang: string): void {
    ...
    (this.i18n.global.locale as { value: string }).value = lang;
    ...
    if ((this.i18n.global.locale as { value: string }).value !== lang) {
      if (!this.loadedLanguages.includes(lang)) {
        return axios.get<any>(`js/langs/${lang}.json`).then(msgs => {
          ...
          return this.i18n as AnyI18n;
        });
      }
    }
    return Promise.resolve(this.i18n as AnyI18n);
  },

  loadLanguage(lang: string, set: boolean): Promise<AnyI18n> {
